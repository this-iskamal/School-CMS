...
export default function () {
  return (
    <div className='flex flex-row justify-between items-center  border-b-2 px-2 py-1'>
        <div className="flex flex-row items-center cursor-pointer" onClick={()=>window.open("/","_self")}>
            <img src="/src/assets/profile.png" alt="" className='h-10 w-10'/>
            <h1 className='font-semibold text-lg sm:text-2xl'>Gaumati Secondary School CMS</h1>
        </div>
        <div className="">
